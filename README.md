...
```text
Set up "empty" reducer and initial state 👉 Set up store and Provider 👉(DONE)
Connect components(Done) 👉 Add events and event handlers in UI 👉 Build action creators 👉
